...
const getCart = async (userId, guestId) => {
    ...
    return null //where both user and guestid are not present
}
...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        if (cart) {
            ...
            if (productIndex > -1) {
                //If the product already exists, upeate the quantity
